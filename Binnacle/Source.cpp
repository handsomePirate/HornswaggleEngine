...
int main(int argc, char **argv)
{
	...
	rm.set_lights(light(glm::vec3(0.0f, 0.1f, 4.0f), glm::vec3(1.0f, 1.0f, 1.0f), 40, 60),
				  light(glm::vec3(3.0f, 0.8f, -0.1f), glm::vec3(1.0f, 1.0f, 1.0f), 40, 20));
	...
	const auto mat_id_notex = rm.create_material(shader_program_id, glm::vec3(0.0f, 0.2f, 0.9f), true);
	
	//rm.load_model("cube.obj", mat_id_tex);
	//rm.load_model("cube.obj", mat_id_notex);
	//rm.load_model("sphere.obj", mat_id_notex);
	rm.load_model("sphere_nouv.obj", mat_id_notex);
